    ...
    <div class="header-top-area">
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <div class="logo-wrapper">
                <a class="themeum-navbar-brand" href="<?php echo esc_url(site_url()); ?>">
                  <?php $logoimg   = get_theme_mod( 'logo', get_template_directory_uri().'/images/logo.png' );
          ...
          <div class="col-md-9">
            <div class="top-sticky-news text-right">
              <p>Our pre-ICO has been started. Hurry upo to get <a href="#">20% bonus!</a></p>
            </div>
          </div>
        </div>
      </div>
