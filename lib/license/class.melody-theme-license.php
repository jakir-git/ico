...
class Personal_Blog_Theme_License{

	private $api_end_point;
	private $theme_name;
	private $theme_version;
	private $website_url = 'https://themeum.com/';
	...
	public function __construct() {
		...
		add_action('admin_menu', array($this, 'thm_theme_license_page'), 20);
	...
	public function license_page_asset_enquee(){
		wp_enqueue_style('plugin-license-handler', MELODY_URI.'lib/license/license.css');
	}

	public function thm_theme_license_page(){
		add_theme_page('License', 'License', 'manage_options', 'melody-theme-license', array($this, 'license_form'));
	}
	...
	public function check_license_key(){
		if ( ! empty($_POST['thm_check_license_code'])){
			...
			$key  = sanitize_text_field($_POST['melody_blog_license_key']);
		...
		<div class="thm-license-head">
			<div class="thm-license-head__inside-container">
				<div class="thm-license-head__logo-container">
					<a href="<?php echo $this->website_url ?>?utm_source=plugin_license&utm_medium=top_menu_link&utm_campaign=activation_license" target="_blank"><img class="thm-license-head__logo" src="https://www.themeum
			.com/wp-content/themes/themeum/images/themeum.svg" /> </a>
				</div>

				<div class="thm-license-head__menu-container">
					<ul>
						<li><a href="<?php echo $this->website_url ?>?utm_source=plugin_license&utm_medium=top_menu_link&utm_campaign=activation_license" target="_blank">Home</a></li>
						<li> <a href="<?php echo $this->website_url ?>wordpress-themes/?utm_source=plugin_license&utm_medium=top_menu_link&utm_campaign=activation_license" target="_blank"> Themes</a></li>
						<li> <a href="<?php echo $this->website_url ?>wordpress-plugins/?utm_source=plugin_license&utm_medium=top_menu_link&utm_campaign=activation_license" target="_blank"> Plugins</a></li>
						<li>
							<a href="#">Support</a>
							<ul class="sub-menu">
								<li><a href="<?php echo $this->website_url ?>support/?utm_source=plugin_license&utm_medium=top_menu_link&utm_campaign=activation_license" target="_blank">Support Forum</a></li>
								<li><a href="<?php echo $this->website_url ?>about-us/?utm_source=plugin_license&utm_medium=top_menu_link&utm_campaign=activation_license" target="_blank">About us</a></li>
								<li><a href="<?php echo $this->website_url ?>docs/?utm_source=plugin_license&utm_medium=top_menu_link&utm_campaign=activation_license" target="_blank">Documentation</a></li>
								<li><a href="<?php echo $this->website_url ?>contact-us/?utm_source=plugin_license&utm_medium=top_menu_link&utm_campaign=activation_license" target="_blank">Contact Us</a></li>
								<li><a href="<?php echo $this->website_url ?>faq/?utm_source=plugin_license&utm_medium=top_menu_link&utm_campaign=activation_license" target="_blank">FAQ</a></li>
							</ul>
						</li>
						<li><a href="<?php echo $this->website_url?>blog/?utm_source=plugin_license&utm_medium=top_menu_link&utm_campaign=activation_license" target="_blank">Blog</a></li>
					</ul>
				</div>
			...
			<div class="themeum-boxes">
				<div class="themeum-box">
					...
					<div class="themeum-right">
						<a href="<?php echo $this->website_url ?>" class="themeum-button themeum-is-primary" target="_blank"> Get License Key</a>
					</div>
					<p> Please enter your license key. An active license key is needed for automatic theme updates and <a href="<?php echo $this->website_url ?>support/" target="_blank">support</a>.</p>
				</div>
				<div class="themeum-box">
					...
					<form action="" method="post">
						...
						<p style="width: 100%; display: flex; flex-wrap: nowrap; box-sizing: border-box;">
							<input id="melody_blog_license_key" name="melody_blog_license_key" size="15" value="" class="regular-text code" style="flex-grow: 1; margin-right: 1rem;" type="text" placeholder="Enter your license key here" />
...
Personal_Blog_Theme_License::init();