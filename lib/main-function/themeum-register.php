...
if(!function_exists('melody_style')):
    ...
    function melody_style(){
        ...
        wp_enqueue_script('slick',MELODY_JS.'slick.min.js',array(),false,true);
...
if(!function_exists('melody_plugins_include')):
    ...
    function melody_plugins_include()
    {
        $plugins = array(
                ...
                array(
                    'name'                  => esc_html__( 'Themeum demo importer', 'melody' ),
                ...
                array(
                    'name'                  => esc_html__( 'Contact Form 7', 'melody' ),
                    'slug'                  => 'contact-form-7',
                    'required'              => false,
                    'version'               => '',
                    'force_activation'      => false,
                ...
                array(
                    'name'                  => esc_html__( 'Elementor', 'melody' ),
                    'slug'                  => 'elementor',
                    'required'              => true,
                    'version'               => '',
                    'force_activation'      => false,
                    'force_deactivation'    => false,
                    'external_url'          => esc_url('https://downloads.wordpress.org/plugin/elementor.2.0.7.zip'),
                ),
                array(
